package com.senchuuhi.netty.proxy.http;


import com.senchuuhi.netty.proxy.http.config.ServerConfigure;
import com.senchuuhi.netty.proxy.http.handler.client.ExceptionDuplexHandler;
import com.senchuuhi.netty.proxy.http.handler.client.JudgeTypeInboundHandler;
import com.senchuuhi.netty.proxy.http.handler.dencrypt.DecryptHandler;
                ...
                .childHandler(new ChannelInitializer<Channel>() {
                    ...
                    protected void initChannel(Channel ch) throws Exception {
                        ch.pipeline()
                                ...
                                .addLast("decoder", new DecryptHandler())
