package com.senchuuhi.netty.proxy.transfer.encrypt;
...
public class SymmetricEncoder {
     ...
     * 6.返回字符串
     */
    public static byte[] AESEncode(byte[] byte_encode, String encodeRules) {
        try {
     ...
     * 3.将加密内容解密
     */
    public static byte[] AESDncode(byte[] content, String encodeRules) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = KeyGenerator.getInstance("AES");
            //2.根据ecnodeRules规则初始化密钥生成器
